...
```bash
curl -X GET \
    -G "http://localhost:8000/_dusk/login/1/" \
...
```javascript
const url = new URL(
    "http://localhost:8000/_dusk/login/1/"
);
...
```bash
curl -X GET \
    -G "http://localhost:8000/_dusk/logout/" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://localhost:8000/_dusk/logout/"
);
...
```bash
curl -X GET \
    -G "http://localhost:8000/_dusk/user/" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://localhost:8000/_dusk/user/"
);
...
<!-- START_028b7228364a9580080a95003591a89a -->
## Enseignant/Note
> Example request:

```bash
curl -X GET \
    -G "http://localhost:8000/Enseignant/Note" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://localhost:8000/Enseignant/Note"
);
...
<!-- END_028b7228364a9580080a95003591a89a -->

<!-- START_e3f5c0ffcf422ff3a486dc08a1bf7542 -->
## envoyerNote
> Example request:

```bash
curl -X POST \
    "http://localhost:8000/envoyerNote" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
<!-- END_e3f5c0ffcf422ff3a486dc08a1bf7542 -->

<!-- START_f7220a182a5ebbaea9a8ffbef6984b59 -->
## informations/{id}
> Example request:

```bash
curl -X GET \
    -G "http://localhost:8000/informations/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://localhost:8000/informations/1"
);
...
<!-- END_f7220a182a5ebbaea9a8ffbef6984b59 -->
